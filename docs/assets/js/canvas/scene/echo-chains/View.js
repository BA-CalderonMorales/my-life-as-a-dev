/**
 * Echo Chains View - Passive Three.js Stage
 * 
...
export class View {
    ...
    addCentralForm(size, colors) {
        ...
        const wireGeo = new THREE.IcosahedronGeometry(size * 1.02, 1);
    ...
    addConnections(connections, color) {
    ...
    updateTheme(colors) {
        ...
        this.rings.forEach(ring => ring.material.color.setHex(colors.glowColor));
    }
