...
- **Pickaxe RAG** via `pickaxe_rag_plugin` to embed answers directly in docs. This uses the [Pickaxe](https://github.com/hatchet-dev/pickaxe) open-source project. See [Pickaxe RAG Integration](docs/pickaxe_rag.md).
